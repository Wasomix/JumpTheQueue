...
namespace Devon4Net.WebAPI.Implementation.Configure
{
    ...
    public static class DevonConfiguration
    {
        ...
        private static void SetupMediatRHandlers(IServiceCollection services)
        {
            ...
            services.AddTransient(typeof(IRequestHandler<GetAllFutballPlayersQuery, List<FutballPlayerDto>>), typeof(GetAllFutballPlayersHandler));
            services.AddTransient(typeof(IRequestHandler<AddNewFutballPlayerCommand, FutballPlayerDto>), typeof(AddNewFutballPlayersHandler));
        }
